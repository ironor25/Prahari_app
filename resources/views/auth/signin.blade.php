            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                    ...
                    <div class="sidemenu-layout-styles">
                        ...
                        <div class="px-4 pb-3 text-secondary fs-11"><span
                                class="fw-medium fs-12 text-dark me-2 d-inline-block">Note:</span>Navigation menu
                            styles
                            won't work here.</div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between canvas-footer gap-1">
                    <a href="https://themeforest.net/user/spruko/portfolio" target="_blank"
                        class="btn btn-primary flex-fill">Buy Now</a>
                    <a href="https://themeforest.net/user/spruko/portfolio" target="_blank"
                        class="btn btn-secondary flex-fill">Our Portfolio</a>
                        ...
                        <form action="{{ route('verifyLoginCredentials') }}" method="post">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <input type="email" class="form-control" id="signin-username" name="email"
                            ...
                            <div class="d-grid mt-4">
                                <input type="submit" class="btn bg-body-tertiary text-white" value="Sign In">
                            </div>
                            <div class="text-center">
                                <p class="text-muted mt-3 mb-0">Dont have an account? <a href="{{ route('signup') }}"
