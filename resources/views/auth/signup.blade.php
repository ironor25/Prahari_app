...
<body class="authentication-background">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('store') }}" id="signupForm">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12">
                                    <label for="signin-type" class="form-label text-default">Login Type</label>
                                    <select class="form-control" id="signin-type" name="role">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Real-time validation for mobile_no on keyup
